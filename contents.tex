...
However, mining bug repositories has its own risks. Previous research has identified problems of missing data \cite{Aranda2009} (e.g., rationale, traceability links between reported bug fixes and source code changes), inaccurate data (e.g., misclassification of bugs) \cite{Antoniol2008}, and biased data \cite{Bird2009}. %,Bird2009,Nguyen2010,Ayari2007}.
