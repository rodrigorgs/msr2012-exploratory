...
However, mining bug repositories has its own risks. Previous research has identified problems of missing data (e.g., rationale, traceability links between reported bug fixes and source code changes) and inaccurate data (e.g., misclassification of bugs) \cite{Aranda2009,Bird2009}. %,Bird2009,Nguyen2010,Ayari2007}.
...
\begin{subsection}{Analysis: How Are Bugs Verified?}
	...
	The regular expressions are available at \url{http://...}. For the sake of simplicity, the following list describes only some substrings matched by the regular expressions for each technique:
