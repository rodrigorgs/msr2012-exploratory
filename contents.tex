...
\begin{subsection}{Preliminary Analysis}
	...
	\begin{itemize}
		...
		\item [(how?)] In both Eclipse and NetBeans, it is common that the fixer requests someone else to verify the fix (``Please verify, Tom'').
		...
		\item [(how)] Eclipse/Platform, bug #210533: ``Verified by code inspection''.
	\end{itemize}
